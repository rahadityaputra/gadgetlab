...
const DeviceCard = ({ id, name, favorites }) => {
  ...
  return (
    <div onClick={() => {navigate(`/device/${id}`)}} className="bg-white shadow-md rounded-lg overflow-hidden w-60 hover:bg-gray-100 cursor-pointer" style={{height: "250px", margin: "auto"}}>
      <a className="p-4">
